...
var RestPlayerController = /** @class */ (function () {
    function RestPlayerController(urlBase) {
        this.urlBase = urlBase;
        this.currentPlayerInfo = null;
    }
    RestPlayerController.prototype.tryCreatePlayer = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, fetch(this.urlBase + "/player?name=" + encodeURIComponent(name), { method: 'PUT' })
